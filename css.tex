...
Same-Origin&270,281&902&733&67&2100\\ \hline
...
In this section, we discuss the shortcomings of other defensive approaches for the cross-origin CSS attack, including client-side and server-side mitigations. Then, we review some current browser defense techniques that are used to defend against similar attacks, including content-sniffing XSS and JavaScript hijacking. We also consider recent research proposals for secure
