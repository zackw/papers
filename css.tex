...
\todo{Include some less common mime types such as application/x-javascript}
% Other MIME types represent various less-frequent \verb|Content-Type|
% headers that our crawler collected for CSS files including \verb|S3Object|,
% \verb|application/x-javascript|, \verb|application/binary|,
