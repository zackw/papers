...
The definition of valid MIME types on each browser implementation slightly differs.
...
Missing&\checkmark&&\checkmark&\checkmark\\ \hline
application/&\checkmark&&\checkmark&\checkmark\\ 
x-unknown-content-type&&&&\\ \hline
...
nosniff\cite{nosniff}

\subsection{JavaScript Hijacking Defenses}
JavaScript hijacking\cite{jshijacking}

\subsection{Browser Strict Modes}
