...
being used to compromise web sites. We surveyed the top 50,000 web sites to
...
\centering
\begin{tabular}{|c|c|c|c|c|c|} \hline
&\multicolumn{2}{|c}{Valid MIME}&\multicolumn{3}{|c|}{Invalid MIME}\\ %\hline
\cline{2-6}
&Well-Formed&Mal-Formed&Well-Formed&Mal-Formed&HTTP Errors\\ \hline
Same-Origin&{\it Coming soon}&440&{\it Coming soon}&26&{\it Coming soon}\\ \hline
Cross-Origin&{\it Coming soon}&75&{\it Coming soon}&0&{\it Coming soon}\\
\hline\end{tabular}
...
% \verb|application/x-pointplus|, \verb|application/x-troff|, \verb|text|,
% \verb|text/javascript|, \verb|text/x-c|, \verb|image/gif| and
...
header in our experiment.~\todo{Fill in with the final number} Most browsers,
