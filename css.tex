...
Within a total of 30379 cross-origin CSS references, we observed that 290 CSS references provided an invalid MIME type. Applying the strict approach of our proposed defense would cause CSS failure in 255 out of the top 50,000 sites. In our observations, all of these cross-origin CSS files with broken MIME types were syntactically well-formed. Thus, applying the conservative approach with additional CSS parsing test would avoid inducing undesired CSS failures on these sites.
